...
integer n,n1,n2,n3,i,io
logical prime,primo
open(unit=20,file='morfeu.dat')
print*, ('Quantas casas de numeros primos de fibonacci voce quer calcular?')
read (*,*) n
...
enddo
!iosat analisa o código
close(30)
end program 
!Essa parte da a condiç‡ao para printar o numero primo
